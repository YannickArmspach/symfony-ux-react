...
import ReactController from '../dist/controller';

// Controller used to check the actual controller was properly booted
class CheckController extends Controller {
    connect() {
        this.element.addEventListener('react:connect', (event) => {
            this.element.classList.add('connected');
            this.element.react = event.detail.react;
        });
    }
}
...
describe('ReactController', () => {
    ...
    it('connect without options', async () => {
        ...
        const react = getByTestId(container, 'canvas').react;
        expect(react.options.showLines).toBe(true);
    });
    ...
    it('connect with options', async () => {
        ...
        const react = getByTestId(container, 'canvas').react;
        expect(react.options.showLines).toBe(false);
    });
});
